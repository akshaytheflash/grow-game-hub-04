-- Fix the database structure for proper functionality

-- Create missing tables for swap functionality
...
-- Create functions for member count management
...
-- Add trigger for swap_listings updated_at
